...
class Cardbuffets extends React.Component {

  componentDidMount() {
    this.props.getAll('/cardbuffet')
  }
        ...
        <Row>
          <Col>
            <Card className={ 'card-' + theme }>
              <CardHeader>
                <h5>
                <i className="fa fa-check"></i> Cartes des Buffets
                </h5>
              </CardHeader>
              <CardBody>
                <DefaultTable 
...
export default connect(mapStateToProps, mapDispatchToProps)(Cardbuffets)
