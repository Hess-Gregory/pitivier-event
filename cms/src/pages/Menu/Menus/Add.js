...
// console.log('event:', event)
    ...
    Promise.resolve( props.save('/menu', body, true ) )
  ...
  return (
    <div>
      <Modal isOpen={modalOpen} toggle={toggleModal} size="lg" className={"modal-"+theme}>
        <ModalHeader toggle={toggleModal}> Ajouter un menu </ModalHeader>
        <AvForm id="addMenu" method="post" onValidSubmit={handleSubmit}>
          <ModalBody>
              {/*<FormGroup row>
                <Col md="3">
